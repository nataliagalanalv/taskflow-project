...
export const FILTER_ACTIVE_CLASSES = ['bg-purple-600', 'dark:bg-fuchsia-600', 'text-white', 'shadow-md'];
export const FILTER_INACTIVE_CLASSES = ['text-slate-600', 'dark:text-slate-400'];
...
export const CHART_COLOR = '#d946ef';
